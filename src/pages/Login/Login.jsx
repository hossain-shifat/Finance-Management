                ...
                <div className="mx-3">
                    <div className="w-full max-w-[450px] p-7 border border-gray-100 rounded-xl shadow-sm bg-base-100 dark:bg-base-300 dark:border-base-200 text-base-content">
                        <form onSubmit={handleLogin}>
                            ...
                            <input className="w-full p-3 rounded bg-base-200 border border-gray-100 outline-none text-[1rem] text-[#333] my-2 placeholder:text-base-content dark:border-base-200" type="email" name='email' ref={emailRef} placeholder='Email' />
                            <span className="relative w-full">
                                <input className="w-full p-3 rounded bg-base-200 border border-gray-100 outline-none text-[1rem] text-[#333] my-2 placeholder:text-base-content dark:border-base-200" type={showPassword ? 'text' : 'password'} name='password' placeholder='Password' />
